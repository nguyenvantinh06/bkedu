    ...
    return (
      ...
      >
        ...
        <View style={styles.loginContainer}>
          ...
          <TouchableOpacity style={styles.forgotPasswordContainer} onPress={() => { this.props.navigation.navigate('ForgotPasswordScreen') }}>
            <Text style={styles.forgotPassword}> Quên mật khẩu? </Text>
          </TouchableOpacity>
          <MyButton title={'Đăng nhập'} backgroundColor={'#00A9B7'} />
          <View style={styles.or}>
            <Text> Hoặc </Text>
          </View>
          <MyButton title={'Đăng nhập với Google'} backgroundColor={'#FE6666'} />
        </View>
